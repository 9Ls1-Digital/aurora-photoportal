 ...
 * Version: 0.7.1-dev.70-field-test-ux-permissions
 * Author: 9Ls1 Digital
 * Text Domain: 9ls1-fotoportal
 */
if (!defined('ABSPATH')) exit;

define('NLS1_FOTOPORTAL_VERSION', '0.7.1-dev.68-download-tracking-project-status');
...
require_once NLS1_FOTOPORTAL_PLUGIN_DIR . 'includes/class-aurora-demo-content.php';
require_once NLS1_FOTOPORTAL_PLUGIN_DIR . 'includes/class-aurora-demo-journey.php';
require_once NLS1_FOTOPORTAL_PLUGIN_DIR . 'includes/class-aurora-test-photographer.php';
...
require_once NLS1_FOTOPORTAL_PLUGIN_DIR . 'includes/class-aurora-auth-adapter.php';
...
if (is_admin()) {
    ...
    new NLS1_Aurora_Demo_Content();
    new NLS1_Aurora_Demo_Journey();
    new NLS1_Aurora_Test_Photographer();
    new NLS1_Photographer_Workspace();
    new NLS1_Fotoportal_Admin();
}
if (!is_admin()) new NLS1_Aurora_Demo_Journey();
new NLS1_Aurora_Fotoportal_Auth_Adapter();
