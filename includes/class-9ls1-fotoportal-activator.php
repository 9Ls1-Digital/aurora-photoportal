...
class NLS1_Fotoportal_Activator {
    ...
    public static function activate() {
        ...
        dbDelta("CREATE TABLE $projects (
            ...
            delivery_mode VARCHAR(30) DEFAULT 'all',
            delivery_status VARCHAR(30) DEFAULT 'draft',
            delivery_released_at DATETIME NULL,
            delivery_zip_url TEXT NULL,
            delivery_selected_zip_url TEXT NULL,
            delivery_terms_version VARCHAR(80) DEFAULT '',
            delivery_terms_accepted_at DATETIME NULL,
            delivery_terms_accepted_user BIGINT UNSIGNED DEFAULT 0,
            delivery_terms_accepted_ip VARCHAR(100) DEFAULT '',
            usage_rights VARCHAR(30) DEFAULT 'free_terms',
        ...
        dbDelta("CREATE TABLE $contracts (
            ...
            contract_source VARCHAR(30) DEFAULT 'aurora',
        ...
        dbDelta("CREATE TABLE $images (
            ...
            edit_status VARCHAR(30) DEFAULT 'none',
            edited_filename VARCHAR(255) DEFAULT '',
            edited_path TEXT NULL,
            edited_url TEXT NULL,
        ...
        dbDelta("CREATE TABLE $comments (
            ...
            client_id BIGINT UNSIGNED NULL,
            user_email VARCHAR(190) DEFAULT '',
            author_type VARCHAR(30) DEFAULT 'customer',
            author_user_id BIGINT UNSIGNED DEFAULT 0,
            is_edit_request TINYINT(1) DEFAULT 1,
